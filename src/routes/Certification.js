...
const Certification = () => {
  // Sample certificate data, replace this with your own certificate details
  const Certifications = [
    ...
    },
    {
      ...
      description:
        "The Student Feedback Form certificate is a web application that allows students to provide feedback using a user-friendly form. It utilizes HTML, CSS, and JavaScript for the frontend interface, while integrating Google Sheets and Apps Script for seamless data storage. Students can easily submit their feedback, which is directly saved into a designated Google Sheets spreadsheet, enabling efficient data collection and analysis. Additionally, the certificate offers the convenience of generating downloadable PDF reports, making it a comprehensive tool for efficient feedback management and analysis.",
      imageUrl: StudentFeedbackForm, // Use the imported image here
      certificateUrl: "https://github.com/prasanthmalla77/Student_FeedbackForm",
      Live: "https://chipper-cobbler-c6a615.netlify.app/",
    },
    {
      title: "Father Resume",
      description:
        "I have developed an online resume for my father using HTML, CSS, and JavaScript. The certificate showcases all the essential details of his background and achievements in a well-organized and visually appealing manner. To make it accessible to a wider audience, I deployed the resume using Netlify, ensuring it can be easily accessed and viewed by anyone online. The combination of HTML, CSS, and JavaScript allowed me to create a dynamic and interactive resume that highlights my father's skills and experience effectively.",
      imageUrl: FatherResume, // Use the imported image here
      certificateUrl: "https://github.com/prasanthmalla77/Father_resume",
    ...
    },
    {
      ...
      certificateUrl: "https://github.com/prasanthmalla77/twitter_clone",
      Live: "https://super-donut-ae36d6.netlify.app/",
    },
    {
      title: "To Do List",
      description:
        "I have developed an interactive To-Do List certificate using HTML, CSS, and JavaScript, which I deployed using Netlify. The application allows users to create and manage their daily tasks in an organized manner. It features a user-friendly interface where tasks can be added, marked as completed, and deleted. The certificate's seamless deployment on Netlify ensures that users can access and use the To-Do List from anywhere with internet access. It's a practical and efficient tool for users to stay organized and keep track of their tasks effortlessly.",
      imageUrl: ToDo, // Use the imported image here
      certificateUrl: "https://github.com/prasanthmalla77/TASK-LIST-USING-JS",
      Live: "https://imaginative-daffodil-5751b1.netlify.app/",
    },
    {
      title: "Automatic Quote Generator",
      description:
        "I have developed an Automatic Quote Generator certificate using HTML, CSS, and JavaScript, which is deployed using Netlify. The application dynamically generates quotes for users, providing an interactive and enjoyable experience. It leverages the power of HTML for structuring the content, CSS for styling the layout, and JavaScript for generating random quotes and displaying them on the screen. The certificate is hosted on Netlify, making it easily accessible to users worldwide. With this application, users can discover and explore an array of quotes effortlessly, enhancing their daily inspiration and motivation.",
      imageUrl: Quote, // Use the imported image here
      certificateUrl: "https://github.com/prasanthmalla77/random_quote_generator",
